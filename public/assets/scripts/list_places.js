...
{
  axios.get('https://back-top-trip.herokuapp.com/places').then((respuesta) => {
    ...
    <div class="row">
      <div class="col">
        <a href="./list_propi.html?place=${respuesta.data[0].place}" style="position: relative" class="list-by-places">
          ...
          <img src="https://back-top-trip.herokuapp.com/${respuesta.data[0].photo.split('/').pop()}" alt="" class="img">
        </a>
      </div>
      <div class="col">
      <a href="./list_propi.html?place=${respuesta.data[1].place}" style="position: relative" class="list-by-places">
          ...
          <img src="https://back-top-trip.herokuapp.com/${respuesta.data[1].photo.split('/').pop()}" alt="" class="img">
        </a>
      </div>
      <div class="col">
        <a href="./list_propi.html?place=${respuesta.data[2].place}" style="position: relative" class="list-by-places">
          ...
          <img src="https://back-top-trip.herokuapp.com/${respuesta.data[2].photo.split('/').pop()}" alt="" class="img">
        </a>
      </div>
    </div>
      <div class="row">
        <div class="col">
          <a href="./list_propi.html?place=${respuesta.data[3].place}" style="position: relative" class="list-by-places">
            ...
            <img src="https://back-top-trip.herokuapp.com/${respuesta.data[3].photo.split('/').pop()}" alt="" class="img">
          </a>
        </div>
        <div class="col">
          <a href="./list_propi.html?place=${respuesta.data[4].place}" style="position: relative" class="list-by-places">
            ...
            <img src="https://back-top-trip.herokuapp.com/${respuesta.data[4].photo.split('/').pop()}" alt="" class="img">
          </a>
        </div>
        <div class="col">
          <a href="./list_propi.html?place=${respuesta.data[5].place}" style="position: relative" class="list-by-places">
            ...
            <img src="https://back-top-trip.herokuapp.com/${respuesta.data[5].photo.split('/').pop()}" alt="" class="img">
          </a>
        </div>
      </div>
      <div class="row">
        <div class="col">
          <a href="./list_propi.html?place=${respuesta.data[6].place}" style="position: relative" class="list-by-places">
            ...
            <img src="https://back-top-trip.herokuapp.com/${respuesta.data[6].photo.split('/').pop()}" alt="" class="img">
          </a>
        </div>
        <div class="col">
          <a href="./list_propi.html?place=${respuesta.data[7].place}" style="position: relative" class="list-by-places">
            ...
            <img src="https://back-top-trip.herokuapp.com/${respuesta.data[7].photo.split('/').pop()}" alt="" class="img">
          </a>
        </div>
        <div class="col">
          <a href="./list_propi.html?place=${respuesta.data[8].place}" style="position: relative" class="list-by-places">
            ...
            <img src="https://back-top-trip.herokuapp.com/${respuesta.data[8].photo.split('/').pop()}" alt="" class="img">
          </a>
        </div>
      </div>
    `
